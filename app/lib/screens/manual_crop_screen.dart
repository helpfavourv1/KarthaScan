...
class _ManualCropScreenState extends State<ManualCropScreen> {
  ...
  Future<void> _confirmCrop() async {
    ...
    try {
      ...
      final List<List<double>> cornerList =
          corners.map((Offset c) => <double>[c.dx, c.dy]).toList();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title:
            Text(l10n.manualCropTitle, style: TextStyle(color: textPrimary)),
              ...
              return SingleChildScrollView(
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    mainAxisAlignment: _stage == _Stage.pickImage
